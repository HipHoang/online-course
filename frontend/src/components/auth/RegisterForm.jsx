...
const RegisterForm = ({ onSwitchType }) => {
    ...
    const handleSubmit = (e) => {
        ...
        // Sau này có backend thì gọi API register ở đây
    };
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                    <input
                        ...
                        className={`w-full rounded-full border px-5 py-3 outline-none transition ${errors.fullName
                ...
                <div>
                    <input
                        ...
                        onChange={handleChange}
                        className={`w-full rounded-full border px-5 py-3 outline-none transition ${errors.confirmPassword
                            ? "border-red-400 bg-red-50 text-red-500 placeholder:text-red-300"
                            : "border-gray-200 bg-white focus:border-[#002B5B]"
                            }`}
                    />
